...
export interface AIEnhancedInsights {
  ...
  summary?: string;
  // Spirit animal fields — all generated by AI from listening data
  musicSpiritAnimal?: string;
  spiritAnimalDescription?: string;
  // Three adjectives that define the user's sound, AI-generated
  threeWordTagline?: string[];
}
